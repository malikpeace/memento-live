...
<<<<<<< HEAD
/* v908: the JS build stamp. The release sed bump rewrites the version in BOTH
=======
/* v905: the JS build stamp. The release sed bump rewrites the version in BOTH
>>>>>>> 8861e76 (v905: fix the Refine-answers path (stale schema + truncating budget))
...
<<<<<<< HEAD
window.MEMENTO_JS_BUILD = 'v908';
=======
window.MEMENTO_JS_BUILD = 'v905';
>>>>>>> 8861e76 (v905: fix the Refine-answers path (stale schema + truncating budget))
/* ============================================
   STATE MANAGEMENT
   ============================================ */
...
<<<<<<< HEAD
  // (v908: "three times a week" in a title left a garbled 7-word fallback
=======
  // (v905: "three times a week" in a title left a garbled 7-word fallback
>>>>>>> 8861e76 (v905: fix the Refine-answers path (stale schema + truncating budget))
...
<<<<<<< HEAD
  // v908: durations are ALLOWED in tier text. They are the one honest scaling
=======
  // v905: durations are ALLOWED in tier text. They are the one honest scaling
>>>>>>> 8861e76 (v905: fix the Refine-answers path (stale schema + truncating budget))
...
<<<<<<< HEAD
  // 9-word ceiling (up from 7, v908). Durations and scope qualifiers are
=======
  // 9-word ceiling (up from 7, v905). Durations and scope qualifiers are
>>>>>>> 8861e76 (v905: fix the Refine-answers path (stale schema + truncating budget))
...
<<<<<<< HEAD
    // v908: title and howToStart are NO LONGER stripped. The strip garbled
=======
    // v905: title and howToStart are NO LONGER stripped. The strip garbled
>>>>>>> 8861e76 (v905: fix the Refine-answers path (stale schema + truncating budget))
