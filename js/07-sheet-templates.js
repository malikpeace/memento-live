...
const SHEET_TEMPLATES = {
  ...
  layout: {
    ...
    DEFAULT_ORDER: [
      ...
      { key: 'vivere', size: 'half' }, { key: 'lifestats', size: 'half' },
  ...
  // (The old Consistency sheet died in v1273: the full ConsistencyPage in
  // js/32 is the module now, and Sheet.open('streak') routes there.)
  flow: {
    render() {
