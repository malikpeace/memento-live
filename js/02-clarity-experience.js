...
function _renderNext7Days() {
  ...
  const DAYS = [
    ...
    { t: 'Ease.', d: "Your brain has stopped fighting you, and the actions feel far more effortless. Inside Memento, you'll see: your streak, the memento itself, your why, the days of proof all reflecting the momentum you built and more. All helping push you forward.\n\nYou've pushed through the hardest part. Memento's only job now is to keep the one move in front of you and keep showing you how far you've come. So KEEP GOING." },
