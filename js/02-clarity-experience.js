  ...
  renderTutorialPage(index) {
    const pages = [
      ...
      // Neutron Star pages.)
      {
        ...
        heroSub: "If you study the most successful people dead or alive, read hundreds of books, watch thousands of videos, and learn from every kind of person across every walk of life, you'd get a thousand different answers on how to \"be successful\".<br><br>But the common denominator between all of them is the same thing: <strong style=\"color:rgba(var(--ink),1)\">progression towards a worthy goal.</strong> Consistent focus, on one direction, over a long period of time. I'd argue it's the most important thing a person can have, and it's also one of the best feelings a human can experience.<br><br>But progression has a step zero almost everyone skips: the worthy goal itself. Before you can move towards anything, you need a mission you care about above all else, one you're willing to commit to and suffer for over an extended period of time.<br><br>Once you find a mission you can obsess over, where not achieving it would feel like a piece of your life is missing, that's when progress becomes automatic. Focus stops being a constant war, and moving toward it becomes inevitable."
      },
