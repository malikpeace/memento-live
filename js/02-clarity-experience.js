...
function _renderNext7Days() {
  ...
  const DAYS = [
    ...
    { t: 'Break off the cobwebs.', d: "Your brain is VERY adaptable. If you force your brain to lock in on something, at some point, it will stop fighting you and start working with you.\n\nI call this breaking off the cobwebs.\n\nImagine your brain as a machine covered in cobwebs. You need to manually force your brain to turn and break off the rust and cobwebs, only in the beginning. Then it becomes a machine that can run with minimal effort.\n\nThis is when momentum starts to work for you, not against you." },
    { t: 'Ease.', d: "This is when your brain stops fighting you and the actions become a lot more effortless. You've pushed through the hardest part and the only thing to do now is KEEP GOING." },
    { t: 'Hooked.', d: "By this point, you will have gotten rewarded or seen some form of progress towards your worthy goal. This will release dopamine, making you crave more and more. Making progression easier than getting distracted.\n\nYou still need to put in effort at times, but it starts to feel like this is just who you are now." },
    { t: 'The Climb.', d: "You know what you want. Why you want it. You know what you have to do to make progress towards your goal. You have actually done the action. You see the progress being made. Your brain is on your side. Progress is automatic. And you're experiencing one of the greatest feelings humans can experience: Progression Towards a Worthy Goal.\n\nThe only thing left to do is to keep going, enjoy the journey and get the most out of your existence.", cls: 'n7d-day--win' }
  ];
