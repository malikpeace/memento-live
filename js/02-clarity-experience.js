  ...
  renderTutorialPage(index) {
    const pages = [
      ...
      // Neutron Star pages.)
      {
        ...
        heroSub: "If you study the most successful people dead or alive, read hundreds of books, watch thousands of videos, and learn from every kind of person across every walk of life, you'd get a thousand different answers on how to \"be successful\".<br><br>But the common denominator between all of them is the same thing: <strong style=\"color:rgba(var(--ink),1)\">consistent, focused action, in one direction, over a long period of time.</strong> That's how results actually get made.<br><br>And underneath that sits something deeper: <strong style=\"color:rgba(var(--ink),1)\">progression towards a worthy goal.</strong> It's one of the best feelings a human can experience, it's what makes people genuinely happy and fulfilled, and it's what makes that level of focus sustainable in the first place. The results and the fulfillment both come from the same engine.<br><br>But progression has a step zero almost everyone skips: the worthy goal itself. Before you can move towards anything, you need a mission you care about above all else, one you're willing to commit to and suffer for over an extended period of time.<br><br>Once you find a mission you can obsess over, where not achieving it would feel like a piece of your life is missing, that's when progress becomes automatic. Focus stops being a constant war, and moving toward it becomes inevitable."
      },
