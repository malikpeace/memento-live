...
const PRECACHE = [
  ...
  './css/install.css', './css/home-refined.css',
  ...
  './js/22-billing.js',
  './js/14-appearance-picker.js', './js/19-dev-loader.js', './js/20-sound.js',
  ...
  './js/30-action-flow.js', './js/33-action-shim.js', './js/15-router.js',
  ...
  './js/35-perfect-week.js', './css/perfectweek.css',
  ...
  './icons/splash/splash-828x1792.png', './icons/splash/splash-1125x2436.png',
  './icons/splash/splash-1170x2532.png', './icons/splash/splash-1179x2556.png',
  './icons/splash/splash-1206x2622.png', './icons/splash/splash-1242x2688.png',
  './icons/splash/splash-1284x2778.png', './icons/splash/splash-1290x2796.png',
