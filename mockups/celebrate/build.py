...
VERDICTS = {
  ...
  'ba-7':'y','ba-8':'y','ba-9':'y',  # ba-6 Countdown, ba-10 Monument CUT
...
<link rel="stylesheet" href="_kit.css?v=tw15">
...
{body}
<script src="chooser.js?v=tw15"></script><script src="_kit.js?v=tw15"></script><script src="_tweaks.js?v=tw15"></script>
